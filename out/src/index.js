    ...
    return new Promise((resolve, reject) => {
        latest_version_1.default(package_json_1.default.name).then(moduleVersion => {
            ...
            if (semver_1.default.lt(package_json_1.default.version, moduleVersion)) {
                ...
                let updateType = (_a = semver_diff_1.default(package_json_1.default.version, moduleVersion)) === null || _a === void 0 ? void 0 : _a.toString();
                if (updateType) {
...
if (options.config) {
    if (fs_1.default.existsSync((expand_tilde_1.default('~/.edit-roblox-place/config.json')))) {
        if (options.config === 'list') {
            ...
            const tableJSON = JSON.parse(fs_1.default.readFileSync((expand_tilde_1.default('~/.edit-roblox-place/config.json')), { encoding: 'utf-8' }));
            ...
            const file = JSON.parse(fs_1.default.readFileSync((expand_tilde_1.default('~/.edit-roblox-place/config.json')), { encoding: 'utf-8' }));
            const question = Object.assign({ choices: Object.keys(file.favourites) }, questions[2]); // TS didn't like adding using .choices!
            inquirer_1.default.prompt([question]).then((answers) => {
                ...
                fs_1.default.writeFileSync((expand_tilde_1.default('~/.edit-roblox-place/config.json')), JSON.stringify(file));
    ...
    if (fs_1.default.existsSync((expand_tilde_1.default('~/.edit-roblox-place/config.json')))) {
        ...
        const configFile = JSON.parse(fs_1.default.readFileSync((expand_tilde_1.default('~/.edit-roblox-place/config.json')), { encoding: 'utf-8' }));
