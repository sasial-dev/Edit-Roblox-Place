...
if (fs_1.default.existsSync((resolve_dir_1.default('~/.edit-roblox-place/config.json')))) {
    ...
    inquirer_1.default.prompt(questions).then((answers) => {
        if (answers.configFile === true) {
            ...
            try {
                fs_1.default.rmSync((resolve_dir_1.default('~/.edit-roblox-place/config.json')));
                fs_1.default.rmdirSync((resolve_dir_1.default('~/.edit-roblox-place')));
            }
            catch (err) {
                console.log(chalk_1.default.redBright(`edit-roblox-place failed to remove the config file! You can remove the folder and its contents yourself at: ${chalk_1.default.white(chalk_1.default.italic(resolve_dir_1.default('~/.edit-roblox-place')))}`));
            }
        }
    });
}
